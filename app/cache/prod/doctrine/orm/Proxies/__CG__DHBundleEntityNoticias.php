...
namespace Proxies\__CG__\DHBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Noticias extends \DHBundle\Entity\Noticias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DHBundle\\Entity\\Noticias' . "\0" . 'id', '' . "\0" . 'DHBundle\\Entity\\Noticias' . "\0" . 'titulo', '' . "\0" . 'DHBundle\\Entity\\Noticias' . "\0" . 'descripcion', '' . "\0" . 'DHBundle\\Entity\\Noticias' . "\0" . 'fecha', '' . "\0" . 'DHBundle\\Entity\\Noticias' . "\0" . 'urlImg');
        }
